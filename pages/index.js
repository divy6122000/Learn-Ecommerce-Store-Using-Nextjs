...
export default function Home() {
  return (
    <div >
      <Head>
        <title>Codeswear - Online codeswear </title>
        <meta name="description" content="Codeswear - Online codeswear " />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <Image className="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" alt="hero" src="/tony.jpg" width={1900} height={600} />
