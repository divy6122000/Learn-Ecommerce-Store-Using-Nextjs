...
const Checkout = ({ addToCart, cart, removeFromCart, clearCart, subTotal }) => {
  return (
    <>
      ...
      <h2 className="mb-4 font-medium md:text-2xl text-center text-heading ">Checkout
            </h2>
              ...
              <div className="">
                ...
                <div className="relative pt-3 xl:pt-6"><label htmlFor="note"
                  ...
                  (Optional)</label><textarea name="note"
                    className="flex items-center w-full px-4 py-3 text-sm border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-pink-500"
                    rows="4" placeholder="Notes for delivery"></textarea>
                </div>
                <div className="mt-4">
                  <button
                    className="w-full px-6 py-2 text-blue-200 bg-pink-500 hover:bg-pink-600">Process</button>
                </div>
              </div>
            </form>
          </div>
              ...
              <div className="mt-8">
                <div className="flex flex-col space-y-4">
                  {Object.keys(cart).map((k) => {
                    return <div className="flex space-x-4" key={k}>
                      <div>
                      ...
                      <div>
                        ...
                        <span className="text-red-600">Price</span> ₹{subTotal}
                      </div>
                      <div>
